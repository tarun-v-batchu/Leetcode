...
# Calling Successor(king, curOrder) will return Alice, so we append to curOrder to get ["king", 
# "Alice"].
# Calling Successor(Alice, curOrder) will return Jack, so we append to curOrder to get ["king", 
# "Alice", "Jack"].
# Calling Successor(Jack, curOrder) will return Bob, so we append to curOrder to get ["king", 
# "Alice", "Jack", "Bob"].
# Calling Successor(Bob, curOrder) will return null. Thus the order of inheritance will be ["king", 
# "Alice", "Jack", "Bob"].
